                ...
                <div class="pt-28 pb-8 md:pt-36 md:pb-16">
                    ...
                    <div class="md:flex md:justify-between">
                            ...
                            <div class="sticky top-8">
                                ...
                                <div class="relative bg-gray-50 rounded-xl border border-gray-200 p-5">
                                    ...
                                    <div class="text-center mb-6">
                                        <img class="inline-flex mb-2" src="./images/company-icon-08.svg" width="72"
                                             height="72" alt="Company 08"/>
                                    ...
                                    <div class="max-w-xs mx-auto mb-5">
                                        <a class="btn w-full text-white bg-indigo-500 hover:bg-indigo-600 group shadow-xs"
                                           href="#0">
                                            Apply Now <span
                                    ...
                                    <div class="text-center">
                                        <a class="text-sm text-indigo-500 font-medium hover:underline" href="#0">Visit
                                            Website</a>
                                    </div>
                        ...
                        <div class="md:grow">
                            ...
                            <div class="pb-8">
                                <div class="mb-4">
                                    <a class="text-indigo-500 font-medium" href="index.html"><span
                                            class="tracking-normal">&lt;-</span> All Jobs</a>
                                </div>
                                <h1 class="text-4xl font-extrabold font-inter mb-10">Engineering Manager Developer
                                    Experience</h1>
                                <!-- Job description -->
                                <div class="space-y-8 mb-8">
                                    <div>
                                        ...
                                        <div class="text-gray-500 space-y-3">
                                            <p>In the world of AI, behavioural predictions are leading the charge to
                                                better machine learning.</p>
                                            <p>There is so much happening in the AI space. Advances in the economic
                                                sectors have seen automated business practices rapidly increasing
                                                economic value. While the realm of the human sciences has used the power
                                                afforded by computational capabilities to solve many human based
                                                dilemmas. Even the art scene has adopted carefully selected ML
                                                applications to usher in the technological movement.</p>
                                            <p>As a Senior Client Engineer, you'll work alongside other engineers,
                                                designers, and product managers to tackle everything from huge company
                                                initiatives to modest but important bug fixes, from start to finish.
                                                You'll also collaborate with your product team on discovery, helping to
                                                assess the direction and feasibility of product changes. And, perhaps
                                                most importantly, you'll actively contribute to the evolution of the
                                                culture and processes of a growing engineering team.</p>
                                        </div>
                                    </div>
                                    <div>
                                        <h3 class="text-xl font-bold text-gray-800 mb-3">About You</h3>
                                        <div class="text-gray-500 space-y-3">
                                            <p>You love building great software. Your work could be supporting new
                                                feature development, migrating existing features, and creating other
                                                mobile and web solutions for customers. You'll have a primary focus on
                                                frontend development using Javascript. Our client's tech stack is
                                                ...
                                                technology. We use modern tools, which means you'll have the opportunity
                                                to work with Webpack, Redux, Apollo, Styled Components, and much
                                                more.</p>
                                            <p>You love learning. Engineering is an ever-evolving world. You enjoy
                                                playing with new tech and exploring areas that you might not have
                                                experience with yet. You are self-driven, self-learner willing to share
                                                knowledge and participate actively in your community.</p>
                                            <p>Having overlap with your team is critical when working in a global remote
                                                team. Modus requires all team members to overlap with EST morning hours
                                                daily. In addition, reliable high speed internet is a must.</p>
                                        </div>
                                    </div>
                                    <div>
                                        <h3 class="text-xl font-bold text-gray-800 mb-3">Things You Might Do</h3>
                                        <div class="text-gray-500 space-y-3">
                                            <p>We are a fast-growing, and remote-first company, so you'll likely get
                                                experience on many different projects across the organization. That
                                                said, here are some things you'll probably do:</p>
                                            <ul class="list-disc list-inside space-y-3">
                                                <li>Give back to the community via open source and blog posts</li>
                                                <li>Travel and meet great people- as part of our remote-first lifestyle,
                                                ...
                                                <li>Teach and be taught: Modus creates active teams that work in
                                                ...
                                                <li>Interact directly with internal and external clients to represent
                                ...
                                <div class="flex items-center justify-end space-x-4">
                                    ...
                                    <ul class="inline-flex space-x-3">
                                        <li>
                                            <a class="flex justify-center items-center text-indigo-500 bg-indigo-100 hover:text-white hover:bg-indigo-500 rounded-full transition duration-150 ease-in-out"
                                ...
                                <div class="flex flex-col border-t border-gray-200">
                                    ...
                                    <div class="nth-[-n+12]:-order-1 border-b border-gray-200 group">
                                        <div class="px-4 py-6">
                                            <div class="sm:flex items-center space-y-3 sm:space-y-0 sm:space-x-5">
                                                <div class="shrink-0">
                                                    <img src="./images/company-icon-04.svg" width="56" height="56"
                                                         alt="Company 04"/>
                                                </div>
                                                <div
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="mb-2">
                                                            <a class="text-lg text-gray-800 font-bold"
                                                               href="job-post.html">Remote Shopify Website Tester</a>
                                                        </div>
                                                        <div class="-m-1">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="lg:group-hover:hidden text-sm italic text-gray-500">
                                                            4h
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="sm:flex items-center space-y-3 sm:space-y-0 sm:space-x-5">
                                                ...
                                                <div
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="mb-2">
                                                            <a class="text-lg text-gray-800 font-bold"
                                                               href="job-post.html">Remote Senior Software Engineer</a>
                                                        </div>
                                                        <div class="-m-1">
                                                            <a class="text-xs text-gray-500 font-medium inline-flex px-2 py-0.5 bg-gray-100 hover:text-gray-600 rounded-md m-1 whitespace-nowrap transition duration-150 ease-in-out"
                                                               href="#0">$100K - $170K</a>
                                    ...
                                    <div class="nth-[-n+12]:-order-1 border-b border-gray-200 group">
                                        <div class="px-4 py-6">
                                            <div class="sm:flex items-center space-y-3 sm:space-y-0 sm:space-x-5">
                                                <div class="shrink-0">
                                                    <img src="./images/company-icon-11.svg" width="56" height="56"
                                                         alt="Company 11"/>
                                                </div>
                                                <div
                                                    class="grow lg:flex items-center justify-between space-y-5 lg:space-x-2 lg:space-y-0">
                                                    <div>
                                                        ...
                                                        <div class="mb-2">
                                                            <a class="text-lg text-gray-800 font-bold"
                                                               href="job-post.html">Remote Cyber Security Analyst US</a>
                                                        </div>
                                                        <div class="-m-1">
                                                            <a class="text-xs text-gray-500 font-medium inline-flex px-2 py-0.5 bg-gray-100 hover:text-gray-600 rounded-md m-1 whitespace-nowrap transition duration-150 ease-in-out"
                                                               href="#0">$55K - $100K</a>
                                                            <a class="text-xs text-gray-500 font-medium inline-flex px-2 py-0.5 bg-gray-100 hover:text-gray-600 rounded-md m-1 whitespace-nowrap transition duration-150 ease-in-out"
                                                               href="#0">🇺🇸 United States</a>
                                                        </div>
                                                    </div>
                                                    <div
                                                        class="min-w-[120px] flex items-center lg:justify-end space-x-3 lg:space-x-0">
                            ...
                            <div>
                                <div class="relative text-center px-4 py-6 group">
                                    ...
                                    <div class="text-2xl font-bold mb-5">Get a weekly email with the latest startup
                                        jobs.
                                    </div>
                                    <form class="inline-flex max-w-sm">
                                        <div
                                            class="flex flex-col sm:flex-row justify-center max-w-xs mx-auto sm:max-w-none">
                                            <input type="email" class="form-input py-1.5 w-full mb-2 sm:mb-0 sm:mr-2"
